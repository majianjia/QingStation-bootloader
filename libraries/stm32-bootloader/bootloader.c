...
//    total_page = (FLASH_BASE + APP_SIZE*4 - APP_ADDRESS) / FLASH_PAGE_SIZE;
//    start_page = (APP_ADDRESS - FLASH_BASE) / FLASH_PAGE_SIZE;
//
//    if(total_page+start_page > FLASH_PAGE_NBPERBANK)
//        NbrOfPages = FLASH_PAGE_NBPERBANK - start_page;
//    else
//        NbrOfPages = total_page;
//    // first bank
...
//
//    if(status == HAL_OK && total_page+start_page > FLASH_PAGE_NBPERBANK)
//    {
//        total_page -= FLASH_PAGE_NBPERBANK - start_page;
//        pEraseInit.Banks     = FLASH_BANK_2;
//        pEraseInit.NbPages   = total_page;
//        pEraseInit.Page      = 0;
//        pEraseInit.TypeErase = FLASH_TYPEERASE_PAGES;
//        status               = HAL_FLASHEx_Erase(&pEraseInit, &PageError);
//    }
