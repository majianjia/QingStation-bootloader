...
#define END_ADDRESS (uint32_t)(0x080FFFFB)     // full
//#define END_ADDRESS (uint32_t)(0x08080000-4) // we only use the first 512k, the last is for later backup.

/** Start address of application checksum in flash */
#define CRC_ADDRESS (uint32_t)(0x080FFFFC)      // full
//#define CRC_ADDRESS (uint32_t)(0x08080000-3)  // half
